...
#test = case_ ~ prop_forest_500m  +prop_pasture_500m + dist_water + log_dist_cities + log_dist_roads + prop_sugarcane_500m + strata(step_id_)
...
m5.1.1.500  = case_ ~ prop_forest_500m  + disp + prop_forest_500m:disp + log_dist_water + strata(step_id_)
